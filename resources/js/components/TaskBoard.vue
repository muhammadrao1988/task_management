        ...
        >
            <div class="rounded-md shadow-md overflow-hidden">
                ...
                <div class="p-2 bg-blue-100">
                    ...
                    >
                        <transition-group
                                class="flex-1 flex flex-col h-full overflow-x-hidden overflow-y-auto drag_min_height rounded shadow-xs"
                                tag="div"
                        >
                            <div
...
<script>
    ...
    export default {
        components: {ViewTaskForm, draggable, AddTaskForm },
        props: {
            initialData: Array
        },
        data() {
...
<style scoped>
    ...
    .drag_min_height { min-height: 80px}
</style>